...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.41\textwidth]{BrainVSVTA.png}
    \hspace{1cm}
    \includegraphics[width=0.41\textwidth]{Brain.png}
    \caption{Schematic illustration of VS-VTA regions and their interactions in mice brain. On the left the mesoscopic vision, VS in yellow is subdivided in odor tuberculum and nucleus accumbens, neurons of VS both project into VTA and receive inputs from VTA. On the right the detailed vision, with specification of the recorded cell-types involved in VS-VTA circuit.}
    \label{fig:Brain}
\end{figure}
\begin{framed}
...
\begin{figure}[H]
  \centering
    \includegraphics[scale=0.36]{figures/VTA_CellClass.png}
