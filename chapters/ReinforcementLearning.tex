...
To easily read the plot in the term of percentage instead of the $\beta$ coefficients, I reported the coefficients transformed as it follows:
\begin{equation}
    \beta^* = \exp(\bar{\beta})-1
    \label{eq:BetaPlot}
\end{equation}
