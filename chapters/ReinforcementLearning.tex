...
From the Bayesian Information Criterion (BIC) the L-F model resulted to be the best model figure \ref{fig:BIC}, confirming the evidences of the action values plots in figure{\color{red} metti la figura del confronto tra modelli}.\\
\begin{figure}
    \centering
...
\begin{figure}[!h]
    \centering
    \includegraphics[scale=0.3]{figures/Rev2An2As1_rew.png}
    \hspace{1cm}
    \includegraphics[scale=0.3]{figures/Rev2An2As2.png}
    
    \vspace{1cm}
    
    \includegraphics[scale=0.3]{figures/Rev2An2As1.png}
    \hspace{1cm}
    \includegraphics[scale=0.3]{figures/Firstrev1An4As5.png}
