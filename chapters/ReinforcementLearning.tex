...
\label{sec:Behavior}
The pure Rescorla-Wagner model is the model with  less number of parameters. {\color{red}add discussion on likelihhod ratio, nested model}The best model was evaluated using the Bayesian Information Criterion, that is formally defined as (\cite{Schwarz})
