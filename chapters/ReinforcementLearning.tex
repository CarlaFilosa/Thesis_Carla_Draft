...
The description made until last paragraph is rather static, whereas the performed task was highly dynamic. In fact the animal had to assign and re-assign a value to the rewarded odor to be able to predict the reward.
