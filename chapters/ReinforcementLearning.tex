...
\begin{figure}
    \centering
    \includegraphics[scale=0.49]{figures/BIC_Value.png}
    
    \vspace{1cm}
    
    \includegraphics[scale=0.49]{figures/DeltaBIC.png}
