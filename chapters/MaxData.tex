...
\begin{figure}
    ...
    \label{fig:GlobalPie}
\end{figure}
Preliminary cell assemblies analysis were aimed to understand the size of the concentration of the shared pairs, namely how many units are involved in pairs and, among those, how the units typologies are distributed in assembly pairs.
We have $803$ VS units and $272$ VTA units in total that were distributed as shown in fig.(\ref{fig:GlobalPie})
