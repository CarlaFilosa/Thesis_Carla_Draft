...
Since we were interested in cross areal interactions between Ventral Striatum and Ventral Tegmental Area, I focus in this work on the inter-regional assemblies. Furthermore the only way to study the directionality between the two region is to focus the assembly analysis at level of inter-regional pairs, namely assembly formed by two neurons, one neuron in Ventral Striatum and one neuron of Ventral Tegmental area. It is easy to understand that, at pairs-level, the lag in activation between units in assembly (one outcome of the cell assembly algorithm) indicates the lag in activation between the two regions of concern.
Using the units classification, inter-regional pairs were classified according to underlying cell types. Classified and not classified units occurred in the two regions as shown in fig. (\ref{fig:fig:PieRegions}). The inter-regional pairs formed by those units occurred as is shown in pie-chart in figure. {\color{red} to be rephrased}. Performing a Pearson's Chi square test...{\color{red} test results}
\begin{figure}
    \centering
...
\begin{tabular}{ |p{3cm}|p{3cm}|p{3cm}|p{3cm}| }
 \hline
 \multicolumn{4}{|c|}{Pearson$'$s $\chi^2$ test} \\
 \hline
 & DAN & GABA & GLU\\
 \hline
 SPN & 135 (102.23) & 70 (89.10) & 11 (24.66)\\
 \hline
 FSN & 97 (136.78) & 148 (119.22) & 44 (33)\\
 \hline
 CIN & 25 (17.99) & 6 (15.68) & 7 (4.34)\\
 \hline
\end{tabular}
\end{table}

\section{Time scales and directionality}
