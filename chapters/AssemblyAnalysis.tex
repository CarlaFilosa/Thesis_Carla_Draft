...
\begin{figure}
 ...
 \begin{figure}
     \centering
     \includegraphics[scale=0.34]{figures/HeatFSN_DANHit.png}
     \includegraphics[scale=0.34]{figures/HeatFA_FSN_DAN1.png}
     \includegraphics[scale=0.34]{figures/HeatCR_FSN_DAN1.png}
