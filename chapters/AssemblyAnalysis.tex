...
\begin{figure}
   ...
   % \includegraphics[scale=0.4]{figures/SPN_DANexStim1.pdf}
    \includegraphics[scale=0.36]{figures/SPN_DANexPreRew.pdf}
    
   \vspace{1cm}
   
   \includegraphics[scale=0.36]{figures/SPN_DANexStim1.pdf}
