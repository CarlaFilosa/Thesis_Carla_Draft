...
\begin{figure}
    \centering
    \includegraphics[scale=0.7]{figures/RewardDoya3_.png}
    \caption{Adapted from \cite{Doya}. In the first two panels we see the cases we already discussed in last paragraph, regarding the rewarded trials. Last panel is related to unrewarded trials, in the cases in which the reward was predicted but it did not occur. Those trials are in our case the False Alarm trials. It is possible to observe an inhibition in correspondence of the $"$expected$"$ reward time.}
