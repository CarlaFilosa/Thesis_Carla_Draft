...
\usepackage[paperwidth=18cm,paperheight=24.5cm,top=2.51cm,bottom=2.005cm,inner=2.5cm,outer=1.5cm,headheight=15.0pt,headsep=0.58cm]{geometry}
...
%\usepackage[backend=biber,style=authoryear, maxnames=4]{biblatex}
%\usepackage[backend=biber, style=apa, apamaxprtauth=<3>]{biblatex}
%\usepackage[maxbibnames=99]{biblatex}
\usepackage[style=authoryear,maxbibnames=99,maxcitenames=2,backend=biber]{biblatex}
